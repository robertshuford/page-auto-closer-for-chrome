...
chrome.runtime.onMessage.addListener((message, sender, sendResponse) => {
  ...
  if (lastActiveTabIdsList.length >= 2) { //There need to be at least 2 tabs in our window's history
    ...
    if (tabId === lastActiveTabId) {
      // This is a case where the tab we are about to close 
      ...
      console.log('PACFC: Recovered the previous active tab.');
    }
  }
...
console.log(`PACFC: page-auto-closer-for-chrome loaded.`)